...
import DemoCodeInfo from '../Components/DemoCodeInfo'


function ClothSimulation() {
    return (
        <div>
            <BackButton style={{marginLeft: '20px', justifyContent: 'unset' }}/>
            ...
            <div className="projectInfo">
                ...
                <DemoCodeInfo code="https://github.com/engbergandreas/cloth-simulation" demo="https://engbergandreas.github.io/cloth-simulation/"></DemoCodeInfo>
