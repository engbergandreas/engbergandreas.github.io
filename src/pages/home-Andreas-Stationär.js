...
function home() {
    return (
        <StyledMain className="mainContent">
            ...
            <Info>
                <p> 
                    Denna texten ska förhoppningsvis beskriva vem Andreas är och vad han tycker om. Vi får se hur pass bra de kan gå.
                    
                    
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. In vulputate consectetur sem,
